...
// document.getElementById("oficina_virtual").classList.toggle('section-image'+ numero)
switch (numero) {
	case '1':
	document.getElementById("oficina_virtual").style.background="url('images/Paso1.jpg')"
	
		break;
		case '2':
		document.getElementById("oficina_virtual").style.background="url('images/Paso2.jpg')"
		
			break;
			case '3':
	document.getElementById("oficina_virtual").style.background="url('images/Paso3.jpg')"
